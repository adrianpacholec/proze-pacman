...
public class MainWindow extends JFrame implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		if(source == new_game){
			...
			int answer = JOptionPane.showConfirmDialog(null, "Czy jesteœ pewien?","Pytanie",JOptionPane.YES_NO_OPTION);
			...
			JOptionPane.showMessageDialog(null,"Ta opcja jeszcze nie jest dostêpna");
