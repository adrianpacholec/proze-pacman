...
/**
 * 
 * Klasa opisująca i tworząca menu główne gry, w którym są przyciski do
 * rozpoczęcia nowej gry, wyswietlenia instrukcji i najlepszych wyników oraz
 * możliwości zakończenia gry
 * 
...
public class MainWindow extends JFrame implements ActionListener {
	...
	public MainWindow() {
		...
		/**
		 * metoda pytająca użytkownika czy jest pewny, że chce zakończyć grę i
		 * zgodnie z jego wolą, albo zamyka okno z men
		 *
		 */
		setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE);
		addWindowListener(new WindowAdapter() {
			public void windowClosing(WindowEvent e) {
				int x = JOptionPane.showConfirmDialog(null, "Czy na pewno chcesz wyjść?", "", JOptionPane.YES_NO_OPTION,
	...
	public void actionPerformed(ActionEvent e) {
		...
		/**
		 * jesli zrodłem jest przycisk nowej gry to tworzone jest okno z wyborem
		...
		/**
		 * jesli zrodłem jest przycisk końca to użytkownuk pytany jest czy jest
		 * tego pewien i albo zamykane jest menu główne albo nic się z nim nie
		 * dzieje
		 */
		else if (source == exit) {
			int answer = JOptionPane.showConfirmDialog(null, "Czy jesteś pewien ?", "Pytanie",
