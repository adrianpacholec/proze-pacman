...
public class GUI {
	...
	public void render(Graphics g, String nick, int points) {
		...
		if (Game.life >= 1)
			g.drawImage(sheet.getSprite(9, 4), 590, 8, null);
		if (Game.life >= 2)
			g.drawImage(sheet.getSprite(9, 4), 550, 8, null);
		if (Game.life >= 3)
			g.drawImage(sheet.getSprite(9, 4), 510, 8, null);
	...
	/**
	 * Metoda rysująca na ekranie planszę informującą o wstrzymaniu gry
	 */
