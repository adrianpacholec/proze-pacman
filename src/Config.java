...
/**
 * Klasa zawierająca stałe operacyjne, dostępne dla wszystkich komponentów
 * programu. Nazwy danych są identyczne z nazwami parametrów konfiguracyjnych.
 *
...
public class Config {
	...
	/**
	 * tytuł okna koniec gry
	 */
	public static String GameOver;

	/**
	 * Metoda parsująca dane konfiguracyjne, w trybie offline, dane sÄ…
